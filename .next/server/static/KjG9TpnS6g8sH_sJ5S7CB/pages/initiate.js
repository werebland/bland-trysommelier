...
var external_react_step_progress_bar_ = __webpack_require__(16);
...
var external_react_dropzone_ = __webpack_require__(11);
...
function initiate_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { initiate_typeof = function _typeof(obj) { return typeof obj; }; } else { initiate_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return initiate_typeof(obj); }

function initiate_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function initiate_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function initiate_createClass(Constructor, protoProps, staticProps) { if (protoProps) initiate_defineProperties(Constructor.prototype, protoProps); if (staticProps) initiate_defineProperties(Constructor, staticProps); return Constructor; }

function initiate_possibleConstructorReturn(self, call) { if (call && (initiate_typeof(call) === "object" || typeof call === "function")) { return call; } return initiate_assertThisInitialized(self); }

function initiate_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function initiate_getPrototypeOf(o) { initiate_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return initiate_getPrototypeOf(o); }

function initiate_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) initiate_setPrototypeOf(subClass, superClass); }

function initiate_setPrototypeOf(o, p) { initiate_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return initiate_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_Component) {
  initiate_inherits(GetStarted, _Component);

  function GetStarted(props) {
    var _this;

    initiate_classCallCheck(this, GetStarted);

    _this = initiate_possibleConstructorReturn(this, initiate_getPrototypeOf(GetStarted).call(this, props));
    _this.state = {
      currentStep: 1,
      menus: []
    };
  ...
  initiate_createClass(GetStarted, [{
    key: "handleDrop",
