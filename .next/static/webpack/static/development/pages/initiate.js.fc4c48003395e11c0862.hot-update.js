  ...
  exit: {
    ...
    x: function x(_ref) {
      var activeStep = _ref.activeStep,
          step = _ref.step;
      return step === activeStep ? 100 : -100;
    }
  }
});
...
var StepperContent = function StepperContent(_ref2) {
  var restaurant = _ref2.restaurant,
      ...
      _handleRestaurantChange = _ref2.handleRestaurantChange,
      menus = _ref2.menus;
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StepperContentContainer, {
    ...
    handleRestaurantChange: function handleRestaurantChange(target) {
      return _handleRestaurantChange(target);
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29
    ...
    __self: this
  })), activeStep === 2 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_MenuAdder__WEBPACK_IMPORTED_MODULE_4__["default"], {
    menus: menus,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33
...
//# sourceMappingURL=initiate.js.fc4c48003395e11c0862.hot-update.js.map