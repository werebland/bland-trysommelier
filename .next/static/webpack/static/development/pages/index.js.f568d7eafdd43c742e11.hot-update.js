...
})(["width:100%;height:75vh;padding:60px 16px 240px 16px;box-sizing:border-box;position:relative;display:flex;flex-flow:column nowrap;align-items:center;justify-content:center;background:#f94343;"]);
...
var HeroButtonLink = Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(next_link__WEBPACK_IMPORTED_MODULE_3___default.a).withConfig({
  displayName: "pages__HeroButtonLink",
  componentId: "sc-1wbo52z-4"
})(["display:none;& a{position:absolute;top:0;right:0;bottom:0;left:0;width:100%;height:100%;opacity:0;text-decoration:none;}"]);
...
})(["width:100%;min-height:600px;display:flex;flex-flow:row nowrap;position:absolute;bottom:-360px;padding:0 16px;box-sizing:border-box;"]);
...
//# sourceMappingURL=index.js.f568d7eafdd43c742e11.hot-update.js.map