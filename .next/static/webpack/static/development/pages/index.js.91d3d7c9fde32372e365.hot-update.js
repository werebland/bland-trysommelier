...
var PricingWrapper = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].section.withConfig({
  ...
  componentId: "cp9je-0"
})(["width:100%;display:flex;flex-flow:column nowrap;align-items:center;padding:16px;@media only screen and (min-width:960px){padding:16px 120px;}"]);
...
var PricingSubtitle = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].h5.withConfig({
  ...
  componentId: "cp9je-2"
})(["font-family:'Montserrat',sans-serif;font-size:2rem;font-weight:800;color:#1f1f1f;margin:0 auto;text-align:center;"]);
...
var PricingCardContainer = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "Pricing__PricingCardContainer",
  componentId: "cp9je-4"
})(["width:100%;border:2px solid #1f1f1f;border-radius:8px;padding:16px;box-sizing:border-box;"]);
...
//# sourceMappingURL=index.js.91d3d7c9fde32372e365.hot-update.js.map