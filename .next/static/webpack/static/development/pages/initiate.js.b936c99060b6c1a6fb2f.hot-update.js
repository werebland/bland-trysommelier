...
var StepperContent = function StepperContent(_ref2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StepperContentContainer, {
    ...
    handleName: function (_handleName) {
      function handleName(_x, _x2) {
        return _handleName.apply(this, arguments);
      }

      handleName.toString = function () {
        return _handleName.toString();
      };

      return handleName;
    }(function (value, i) {
      return handleName(value, i);
    }),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34
...
//# sourceMappingURL=initiate.js.b936c99060b6c1a6fb2f.hot-update.js.map