    ...
    <Grid container spacing={16} style={{marginBottom: '68px'}}>
      ...
      <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
        <FeatureCard>
          ...
          <FeatureCardCopy>
            As your menu changes, so does Sommelier. Add specials, item options, and multiple menus, supercharging your menu to do what it does best: convert potential diners.
          </FeatureCardCopy>
        </FeatureCard>
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
