...
})(["width:100%;height:100%;min-height:100vh;padding:96px 16px 16px;box-sizing:border-box;background:#f94343;@media only screen and (min-width:960px){padding:96px 120px 16px;}"]);
...
})(["position:fixed;bottom:10px;right:16px;z-index:7;height:64px;box-sizing:border-box;background:#fff;border-radius:8px;box-shadow:0 2px 16px -2px rgba(31,31,31,0.32) !important;padding:16px 72px 16px 8px;display:flex;align-items:center;font-family:'Montserrat',sans-serif;font-weight:700;color:#1f1f1f;"]);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Index, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(IndexWrapper, {
        ...
        __self: this
      }, "Try out Somm now"), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_components_SommWidget__WEBPACK_IMPORTED_MODULE_21__["default"], {
        username: "xoh",
        iconColor: "#f94343",
        backgroundColor: "#fff",
        position: "right",
...
//# sourceMappingURL=index.js.6d5d2f85deea6780af4f.hot-update.js.map