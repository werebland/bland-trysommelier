...
})(["width:100%;min-height:600px;display:flex;flex-flow:column nowrap;position:relative;margin-top:-240px;z-index:8;padding:0 16px;box-sizing:border-box;"]);
...
})(["width:100%;max-width:240px;border-radius:8px;padding:16px;box-sizing:border-box;box-shadow:0 2px 16px -2px rgba(31,31,31,0.32);background:#fff;display:flex;flex-flow:row nowrap;"]);
...
})(["display:inline-flex;flex-flow:column nowrap;align-items:flex-start;"]);
...
//# sourceMappingURL=index.js.4c975fed0a8999890bb2.hot-update.js.map