...
})(["font-family:'Montserrat',sans-serif;font-size:2.5rem;font-weight:800;color:#fff;background:#f94343;margin:0 auto;display:inline-block;text-align:center;& span{display:block;}& span:after{content:\"\";width:100%;height:8px;background:#f94343;display:block;position:absolute;bottom:0px;left:4px;z-index:-1;}"]);
...
var Features = function Features(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FeaturesContainer, {
    ...
    __self: this
  }, "Your menu converts browsers to diners.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 40
    },
...
//# sourceMappingURL=index.js.372e8d63648f5e5cb16d.hot-update.js.map