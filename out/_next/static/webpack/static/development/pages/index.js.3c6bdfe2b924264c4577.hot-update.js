...
var PricingCardTitle = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].h4.withConfig({
  ...
  componentId: "cp9je-5"
})(["font-family:'Montserrat',sans-serif;font-size:1.5rem;font-weight:800;color:", ";"], function (props) {
  return props.primary ? '#f94343' : '#1f1f1f';
});
var PricingCardPrice = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].span.withConfig({
  ...
  componentId: "cp9je-6"
})(["font-family:'Montserrat',sans-serif;font-size:4rem;font-weight:800;color:#1f1f1f;position:relative;padding:0 16px;display:flex;align-items:flex-start;&::before{content:\"$\";position:absolute;top:0;left:0;font-family:'Montserrat',sans-serif;font-size:1rem;font-weight:800;}"]);
...
var Pricing = function Pricing(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PricingWrapper, {
    ...
    __self: this
  }, "0"))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_3___default.a, {
    item: true,
    xs: 12,
    sm: 6,
    md: 4,
...
//# sourceMappingURL=index.js.3c6bdfe2b924264c4577.hot-update.js.map