...
})(["width:100%;max-width:360px;height:600px;display:block;background:aliceblue;border-radius:8px;@media only screen and (min-width:600px){margin:0 16px 0}"]);
...
})(["display:flex;flex-flow:column nowrap;@media only screen and (min-width:600px){width:100%;max-width:240px;}"]);
...
})(["width:100%;border-radius:8px;padding:16px;box-sizing:border-box;box-shadow:0 2px 16px -2px rgba(31,31,31,0.32);background:#fff;display:flex;flex-flow:row nowrap;"]);
...
//# sourceMappingURL=index.js.7d1f4dcd7407d9776784.hot-update.js.map