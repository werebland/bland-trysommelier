...
})(["font-size:1.5rem;font-weight:700;font-family:'Montserrat',sans-serif;color:#1f1f1f;position:relative;&:after{content:\"\";width:100%;height:4px;background:#f94343;display:block;position:absolute;bottom:4px;left:4px;}"]);
...
var Pricing = function Pricing(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PricingWrapper, {
    ...
    __self: this
  }, "Early Access: While Somm is in early access, your plan includes unlimited items with all features for no charge."), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PricingGrid, {
    container: true,
    spacing: 8,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.8cc11ab6d3f894d1269e.hot-update.js.map