...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Index, [{
    ...
    value: function handleCapture(e) {
      ...
      console.log(email);
      var auth = _config__WEBPACK_IMPORTED_MODULE_15__["default"].initializedApp.auth;
      firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth().signInAnonymously().catch(function (error) {
        // Handle Errors here.
        console.log(error);
        var errorCode = error.code;
        var errorMessage = error.message; // ...
      });
      firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth().onAuthStateChanged(function (user) {
        if (user) {
          // User is signed in.
          ...
          _config__WEBPACK_IMPORTED_MODULE_15__["default"].addToCollection('restaurants', data).then(function () {
            console.log('success');
          }).catch(function (err) {//handle error
          });
          next_router__WEBPACK_IMPORTED_MODULE_16___default.a.push('/initiate'); // ...
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(IndexWrapper, {
        ...
        __self: this
      }, "Supercharge your business with Somm, a personal assistant for your menu with powerful features and valuable insights."), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_components_AccessForm__WEBPACK_IMPORTED_MODULE_19__["default"], Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
        ...
        __self: this
      })))), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_components_Pricing__WEBPACK_IMPORTED_MODULE_18__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 218
        },
...
//# sourceMappingURL=index.js.80da1caa66264966a188.hot-update.js.map