...
})(["width:100%;display:flex;align-items:center;justify-content:flex-start;flex-flow:column nowrap;position:relative;&:after{content:\"</>\";position:absolute;top:0;left:0;display:block;z-index:-1;}"]);
...
})(["display:inline-flex;font-size:1.5rem;font-weight:900;font-family:'Source Sans Pro',sans-serif;color:#1f1f1f;margin:0 0 4px;position:relative;&:after{content:", ";width:100%;height:8px;background:#f94343;display:block;position:absolute;bottom:0;left:4px;z-index:-1;}"], function (props) {
  return props.icon;
});
...
//# sourceMappingURL=index.js.4e8ea5fde656542d57ea.hot-update.js.map